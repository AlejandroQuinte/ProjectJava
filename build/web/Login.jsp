<%-- 
    Document   : Login
    Created on : may 13, 2022, 10:07:21 p.m.
    Author     : alequ
--%>
            ...
            <div class="">
                <div  >
                    ...
                    <div>
                        ...
                        %>
                        <span class="error"><%=request.getParameter("create")%></span>
                        <%}%>
                    </div>
                    <div id="id01" class="modal">
                        ...
                        <form class="modal-content animate" action="Login" method="post">
                            ...
                            <div class="container">
                                ...
                                <input type="text" placeholder="Enter Username" name="txtUsuario" id="txtUsuario" autocomplete="off" required>
