<%-- 
    Document   : FrmCliente
    Created on : may 6, 2022, 10:12:09 a.m.
    Author     : alequ
--%>
    ...
    <body>
                    ...
                    <form action="CrearModificarCliente" method="post" id="form_AgregarModificar">
                        ...
                        * Cada form-group es una fila, para que se coloquen horizontalmente
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="txtCodigo" name="txtCodigo" value="<%=cliente.getIdCliente()%>"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="txtNombre" name="txtNombre"  autocomplete="off" value="<%=cliente.getNombre()%>" class="form-control"/><br>
                        </div>

                        <div class="form-group">
                            <label for="txtApellido" class="control-label">Apellido</label>
                            <input type="text" id="txtApellido" name="txtApellido"  autocomplete="off" value="<%=cliente.getApellido()%>"
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" id="txtCorreoElectronico" autocomplete="off" name="txtCorreoElectronico" value="<%=cliente.getCorreoElectronico()%>"
                                   class="form-control"/><br>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="txtTelefono" name="txtTelefono" value="<%=cliente.getTelefono()%>" autocomplete="off" class="form-control" placeholder="00-00-00-00"/><br>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input type="button" id="btnRegresar" value="Regresar"
                                       onclick="location.href = 'FrmListarClientes.jsp'" class="btn btn-secondary"/>
        ...
        <script>
                                           ...
                                           txtNombre: {required: true, maxlength: 50},
                                                   ...
                                                   txtCorreoElectronico: {required: true, maxlength: 50}
                                           ...
                                           // Nota: Para determinar estos tamaños debemos verificar las restricciones de nuestra BD
                                                   ...
                                                   txtNombre: "El campo de Nombre es obligatorio (max 50 caracteres)",
                                                           ...
                                                           txtCorreoElectronico: "El campo Dirección es obligatorio"
                                                   },
                                                   errorElement: 'span'
